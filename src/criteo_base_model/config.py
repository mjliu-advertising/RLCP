...
def init_parser(campaign_id):
    ...
    parser.add_argument('--dataset_name', default='criteo/', help='ipinyou, criteo, yoyi, avazu')
    parser.add_argument('--campaign_id', default='3476/', help='1458, 3358, 3386, 3427, 3476, avazu')
